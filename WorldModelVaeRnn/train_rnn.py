...
def train(args):
    ...
    # load data
    z, a, img_paths = load_latent_npz(args.latent_dataset_path)
    N, z_dim = z.shape
    ...
    print(
        f"Loaded {N} samples from {args.latent_dataset_path}, z_dim={z_dim} a_dim={action_dim}"
    )
...
def parse_args():
    ...
    p.add_argument("--latent_dataset_path", type=str, default="latent_dataset.npz")
    p.add_argument("--output_dir", type=str, default="rnn_outputs")
